...
def generator_unet(image, options, reuse=False, name="generator"):
    ...
    dropout_rate = 1.0 if options.is_training else 1.0 ###### TODO
    with tf.variable_scope(name):
        ...
        # image is (256 x 256 x input_c_dim)
        e1 = batch_norm(conv2d(image, options.gf_dim, name='g_e1_conv'))
        ...
        d7 = deconv2d(tf.nn.relu(e2), options.gf_dim, name='g_d7')          ##### TODO
